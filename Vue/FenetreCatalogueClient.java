...
public class FenetreCatalogueClient extends JFrame {
    ...
    public FenetreCatalogueClient(DaoFactory daoFactory, Client client) {
        this.daoFactory = daoFactory;
        this.panier = new Panier(client);
        this.panierController = new PanierController(panier, new ProduitDAOImpl(daoFactory), client);
        ...
        ajouterBtn.addActionListener(e -> {
            panierController.ajouterProduit(table, tableModel, this);
        });
        ...
        avisBtn.addActionListener(e -> {
            ...
            if (selectedRow >= 0) {
                ...
                new FenetreDonnerAvis(daoFactory, idProduit);
            } else {
        ...
        voirAvisBtn.addActionListener(e -> {
            ...
            if (selectedRow >= 0) {
                int idProduit = Integer.parseInt(tableModel.getValueAt(selectedRow, 0).toString());
                new FenetreVoirAvis(daoFactory, idProduit);
            } else {
